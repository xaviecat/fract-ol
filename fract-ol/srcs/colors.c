...
/*   Updated: 2023/01/30 16:58:59 by xcharra          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	color_pixels(t_cplx *fractal, size_t i)
{
	...
	n_color = 0;
	n_color = fractal->color_derv + (0 << 24 | (0) << 16 | (0) << 8 | (0));
	n_color = fractal->color_derv + (((0 << 24) & 0xFF) | (((color) << 16) & 0xFF) | (((color) << 8) & 0xFF) | (((color) & 0xFF)));
